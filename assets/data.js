...
window.BT_DATA = {
  ...
  activities: [
    ...
    {"id":"a3","title":"Rearrange one corner of your room","description":"Don't redo the whole room - just transform a single corner into a reading nook, plant shelf, or vibe zone.","difficulty":"Medium","time":"45 min","moods":["Indoor","Creative","Energetic"],"image":"https://picsum.photos/seed/acta3/800/600"},
    ...
    {"id":"a5","title":"Write a letter to your future self","description":"Use a free 'future email' service and send a message to yourself one year from now. Brutally honest encouraged.","difficulty":"Easy","time":"15 min","moods":["Indoor","Creative","Lazy"],"image":"https://picsum.photos/seed/acta5/800/600"},
    ...
    {"id":"a8","title":"Start a 30-second daily journal","description":"One sentence about today. That's it. Future-you will love having a record of this random afternoon.","difficulty":"Easy","time":"5 min","moods":["Indoor","Lazy","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta8/800/600"},
    {"id":"a9","title":"Teach yourself to draw one thing well","description":"Pick a single object - a coffee cup, a hand, a cat - and draw it 10 times until it looks great.","difficulty":"Medium","time":"40 min","moods":["Indoor","Creative"],"image":"https://picsum.photos/seed/acta9/800/600"},
    ...
    {"id":"a12","title":"Have a solo dance party","description":"Three songs, lights low, zero judgement. Scientifically proven to reset a bored brain.","difficulty":"Easy","time":"10 min","moods":["Indoor","Energetic","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta12/800/600"},
    {"id":"a13","title":"Text three people you haven't talked to in a while","description":"A simple 'you popped into my head today' message can turn a dull day into a great conversation.","difficulty":"Easy","time":"10 min","moods":["Social","5-Minute Fixes","Lazy"],"image":"https://picsum.photos/seed/acta13/800/600"},
    {"id":"a14","title":"Build a blanket fort like you're 8 again","description":"Cushions, fairy lights, snacks. Climb in with a movie. Nostalgia is a powerful boredom cure.","difficulty":"Easy","time":"20 min","moods":["Indoor","Lazy","Creative"],"image":"https://picsum.photos/seed/acta14/800/600"},
    {"id":"a15","title":"Try a 10-minute guided meditation","description":"Follow a free guided session. Even ten minutes can flip your mood from restless to calm.","difficulty":"Easy","time":"10 min","moods":["Indoor","Lazy"],"image":"https://picsum.photos/seed/acta15/800/600"},
    {"id":"a16","title":"Make a themed playlist","description":"Pick an oddly specific vibe - 'main character walking in the rain' - and build the perfect 20-song soundtrack.","difficulty":"Easy","time":"25 min","moods":["Indoor","Creative","Lazy"],"image":"https://picsum.photos/seed/acta16/800/600"},
    ...
    {"id":"a19","title":"Learn 5 phrases in a new language","description":"Hello, thank you, where's the bathroom, and two fun ones. Future-traveler-you says thanks.","difficulty":"Easy","time":"15 min","moods":["Indoor","Lazy"],"image":"https://picsum.photos/seed/acta19/800/600"},
    ...
    {"id":"a24","title":"Make a 'bucket list' of 25 things","description":"Big, small, silly, scary. Writing them down makes them feel real - and gives you a to-do list for life.","difficulty":"Easy","time":"20 min","moods":["Indoor","Lazy","Creative"],"image":"https://picsum.photos/seed/acta24/800/600"},
    ...
    {"id":"a27","title":"Write the first page of a story","description":"Just one page. Start with 'The lights went out at exactly 3:00 AM...' and see where it goes.","difficulty":"Medium","time":"25 min","moods":["Indoor","Creative","Lazy"],"image":"https://picsum.photos/seed/acta27/800/600"},
    {"id":"a28","title":"Reorganize your phone home screen","description":"Aesthetic icons, fresh wallpaper, ruthless app cleanup. A tiny digital glow-up for a bored afternoon.","difficulty":"Easy","time":"20 min","moods":["Indoor","Lazy","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta28/800/600"},
    ...
    {"id":"a32","title":"Make a vision board","description":"Cut from magazines or build a digital collage of the life you're chasing. Pin it where you'll see it daily.","difficulty":"Medium","time":"45 min","moods":["Indoor","Creative","Lazy"],"image":"https://picsum.photos/seed/acta32/800/600"},
    {"id":"a33","title":"Go stargazing (or cloud-gazing)","description":"Head outside, lie back, and just look up. Find one constellation or one cloud that looks like a dog.","difficulty":"Easy","time":"20 min","moods":["Outdoor","Lazy"],"image":"https://picsum.photos/seed/acta33/800/600"},
    ...
    {"id":"a35","title":"Learn to juggle","description":"Start with two balls (or rolled socks). It's frustrating for ten minutes, then suddenly clicks.","difficulty":"Medium","time":"30 min","moods":["Indoor","Energetic"],"image":"https://picsum.photos/seed/btact35/800/600"},
    {"id":"a36","title":"Do a digital declutter","description":"Delete 50 old photos, unsubscribe from 10 emails, and clear your downloads folder. Feels like a deep breath.","difficulty":"Easy","time":"30 min","moods":["Indoor","Lazy"],"image":"https://picsum.photos/seed/acta36/800/600"},
    {"id":"a37","title":"Try a one-line-a-day drawing diary","description":"Draw your day as a single doodle. Keep them in one notebook and watch your year illustrate itself.","difficulty":"Easy","time":"5 min","moods":["Indoor","Creative","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta37/800/600"},
    ...
    {"id":"a40","title":"Map out a 'someday' skill tree","description":"List skills you want one day, then break the first one into a tiny first step you can do this week.","difficulty":"Easy","time":"20 min","moods":["Indoor","Lazy","Creative"],"image":"https://picsum.photos/seed/acta40/800/600"},
    ...
    {"id":"a43","title":"Write a fake five-star review for your day","description":"Review today like it's a product. '3 stars - great snacks, weak plot.' Surprisingly funny and clarifying.","difficulty":"Easy","time":"5 min","moods":["Indoor","Creative","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta43/800/600"},
    ...
    {"id":"a45","title":"Do a 'yes day' for small things","description":"For one afternoon, say yes to every small harmless impulse. Ice cream for lunch? Yes. Detour? Yes.","difficulty":"Easy","time":"Half day","moods":["Social","Outdoor","Energetic"],"image":"https://picsum.photos/seed/acta45/800/600"},
    {"id":"a46","title":"Recreate a restaurant meal at home","description":"Pick a dish you love from a restaurant and try to copy it. Even a flawed attempt is a fun mission.","difficulty":"Hard","time":"75 min","moods":["Indoor","Creative"],"image":"https://picsum.photos/seed/acta46/800/600"},
    {"id":"a47","title":"Make a 'top 5 of everything' list","description":"Top 5 movies, snacks, songs, memories, fictional crushes. Text it to a friend and compare instantly.","difficulty":"Easy","time":"15 min","moods":["Social","Lazy","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta47/800/600"},
    ...
    {"id":"a50","title":"Learn a 30-second magic-ish skill","description":"Whistle louder, wiggle your ears, do a coin roll. Pointless party tricks are pure boredom fuel.","difficulty":"Medium","time":"15 min","moods":["Indoor","5-Minute Fixes"],"image":"https://picsum.photos/seed/btact50/800/600"},
    {"id":"a51","title":"Plan a budget picnic","description":"Pack whatever's in the kitchen, grab a blanket, and eat outside. Food just tastes better on grass.","difficulty":"Easy","time":"40 min","moods":["Outdoor","Social","Lazy"],"image":"https://picsum.photos/seed/acta51/800/600"},
    ...
    {"id":"a54","title":"Build a personal 'hype' folder","description":"Screenshot every nice text, win, and good memory into one folder. Bored-day fuel and rough-day medicine.","difficulty":"Easy","time":"15 min","moods":["Indoor","Lazy","5-Minute Fixes"],"image":"https://picsum.photos/seed/acta54/800/600"},
    ...
    {"id":"a56","title":"Invent a signature mocktail","description":"Mix, taste, adjust, name it after yourself. Bottle the recipe for your next hangout.","difficulty":"Medium","time":"25 min","moods":["Indoor","Creative","Social"],"image":"https://picsum.photos/seed/acta56/800/600"},
  ],
